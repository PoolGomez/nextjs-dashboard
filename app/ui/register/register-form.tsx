'use client';
import { registerUser } from "@/app/lib/actions/authentication";
import Link from "next/link";
import { useEffect, useState } from "react";
import { useFormState } from "react-dom";
import NotificationsOne from "../notifications/NotificationsOne";
  ...
  return (
    <form action={dispatch}>
      ...
      <div className="mb-5">
        ...
        //   onClick={comprobarPass}
        />
        {
            state && <p className="mt-2 text-sm text-red">
                {state.message}
            </p>
        }
      </div>
