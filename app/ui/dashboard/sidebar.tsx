    ...
    return (
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          ...
          {/* <img width={176} height={32} src={'/images/logo/logo.svg'} alt="Logos" /> */}
          {/* <Image width={176} height={32} src={"/images/logo/logo.svg"} alt="Logos"  /> */}
          <AcmeLogo color="white" />
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className={`mb-4 ml-4 text-sm font-semibold text-${colorTexto} text-bodydark2`}>
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/dashboard"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-${colorTexto} text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
